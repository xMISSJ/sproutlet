...
<template>
  <article
    class="group relative z-[var(--card-z,1)] isolate cursor-pointer overflow-visible hover:z-40 focus-visible:rounded-[1.25rem] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[rgba(117,210,188,0.7)]"
    role="link"
    tabindex="0"
      ...
      <div class="absolute inset-0 z-[1] flex flex-col">
        ...
        >
          <img
            ...
            :src="imageUrl"
            :alt="item.nickname"
            class="pointer-events-none block h-auto w-[82%] max-w-full origin-bottom object-contain object-bottom drop-shadow-[0_18px_24px_rgba(0,0,0,0.45)] transform-gpu transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.04]"
            draggable="false"
          />
          <span
            v-else
        ...
        >
          ...
          <div class="flex flex-wrap items-center gap-1.5">
            ...
            <span
              class="ml-auto inline-flex h-8 w-8 items-center justify-center text-white/70 transition-colors duration-300 group-hover:text-white"
              aria-hidden="true"
            >
